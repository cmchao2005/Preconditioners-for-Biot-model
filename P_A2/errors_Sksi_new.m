function [ el2, eh1 ] =  errors_Sksi_new ( element_area, element_node, node_xy, numerical_sol, element_num, nnodes, nq,t)
...
%
    ...
    for quad = 1 : nq
      ...
      for node = 1 : nnodes
          ...
          [ bi, dbidx, dbidy ] = lbf ( x, y, element, node, node_xy, ...
            element_node);
      ...
      u=True_solution(3,0,0,x,y,t);
      dudx=True_solution(3,1,0,x,y,t);
      dudy=True_solution(3,0,1,x,y,t);
