function [ el2, eh1 ] =  errors_SP_new ( element_area, element_node, node_xy, numerical_sol, element_num, nnodes, nq, t)
...
%
    ...
    for quad = 1 : nq
      ...
      u=True_solution(4,0,0,x,y,t);
      dudx=True_solution(4,1,0,x,y,t);
      dudy=True_solution(4,0,1,x,y,t);
